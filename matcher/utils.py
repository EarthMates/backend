...
def run_startup_matcher(startup_name):
    ...
    for investor in investor_list:
        ...
        print("Checking match of " + startup.name + " and " + investor.name + "")
        ...
        if (
            ...
            if existing_match:
                ...
                print(f"Deleted existing match between {startup.name} and {investor.name}")
                ...
                if reciprocal_match:
                    ...
                    print(f"Deleted reciprocal match between {investor.name} and {startup.name}")
            continue
...
def run_investor_matcher(investor_name):
